...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	if(mouseColor == backgroundColor) {
		...
		if(mouseColor == -3342448) {
			JOptionPane.showMessageDialog(null, "You won! Your feet survived!");
		}
	...
	private void scare() {
		...
		sound.play();
		JOptionPane.showMessageDialog(null, "Ouch! Your feet burned off!");
